...
const AviatorBets = () => {
  ...
  const fetchData = async () => {
    try {
      const response = await axios.get(`https://ajayluckybrust.today/api/getTrans?phone=${phone}`);
    ...
    <div>
      ...
      >
        ...
        <div style={{ marginLeft: '6in' }}>
          <h2 style={{ color: 'black' }}>History of Aviator Bets</h2>
        </div>
      </header>
